...
func TestBug19_PackageFilteringIssue(t *testing.T) {
	...
	callGraphGenNoFilter.SetPerformanceConfig(false, true, true) // Include everything like CLI
	...
	callGraphGenFiltered.SetPerformanceConfig(true, false, false) // Filter like our FBOM generator
