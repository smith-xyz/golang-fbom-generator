...
// SetPerformanceConfig is deprecated and maintained for backward compatibility.
// Call graph generation now always uses complete analysis for accuracy.
func (g *Generator) SetPerformanceConfig(userFuncsOnly, includeStdlib, includeDeps bool) {
}
